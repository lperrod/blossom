...
public class ElasticsearchIndexationEngineImpl<DTO extends AbstractDTO> implements IndexationEngine {

  private final static Logger logger = LoggerFactory.getLogger(ElasticsearchIndexationEngineImpl.class);
  ...
  public ElasticsearchIndexationEngineImpl(Client client, ReadOnlyService<DTO> service,
