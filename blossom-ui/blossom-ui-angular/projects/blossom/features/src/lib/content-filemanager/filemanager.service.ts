...
export interface FileDTO { id: string; name: string; path: string; contentType: string; extension: string; size: number; tags: string[]; hash: string; }
...
export class FileManagerService {
  ...
  get(id: string): Observable<FileDTO> { return this.http.get<FileDTO>(`${this.API}/${id}`); }
