...
@Component({ selector: 'app-role-create-dialog', standalone: true, imports: [CommonModule, FormsModule, MatDialogModule, MatFormFieldModule, MatInputModule, MatButtonModule],
...
export class RoleCreateDialogComponent {
  ...
  constructor(public ref: MatDialogRef<RoleCreateDialogComponent>, private svc: RolesService, private notify: NotificationService) {}
