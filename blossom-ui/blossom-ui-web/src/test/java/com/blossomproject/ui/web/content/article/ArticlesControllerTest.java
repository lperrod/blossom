...
public class ArticlesControllerTest {
  ...
  @Mock
  private SearchEngine<? extends AbstractQueryBuilder, ? extends AbstractSearchRequestBuilder, ? extends AbstractSearchResponse, ArticleDTO> searchEngine;

  private ArticlesController articlesController;

  @Before
  public void setUp() {
    articlesController = new ArticlesController(articleService, searchEngine);
  }
  ...
  public void should_delete_one_with_id_found_with_conflict() throws Exception {
    ...
    when(articleService.delete(any(ArticleDTO.class), eq(false))).thenReturn(
      Optional.of(ImmutableMap.<Class<? extends AbstractDTO>, Long>builder().put(ArticleDTO.class, 2L).build()));
