...
public class ApiControllerGenerator implements ClassGenerator {
  ...
  private JMethod buildCreate(JDefinedClass definedClass, Settings settings,
    ...
    body._return(
      JExpr._new(codeModel.ref(ResponseEntity.class).narrowEmpty()).arg(JExpr.ref(service).invoke("create").arg(createForm))
        .arg(codeModel.ref(HttpStatus.class).staticRef("CREATED")));
  ...
  private JMethod buildGet(JDefinedClass definedClass,
    ...
    ifCondition._then()._return(
      JExpr._new(codeModel.ref(ResponseEntity.class).narrowEmpty()).arg(codeModel.ref(HttpStatus.class).staticRef("NOT_FOUND")));
    ifCondition._else()._return(JExpr._new(codeModel.ref(ResponseEntity.class).narrowEmpty()).arg(entity)
  ...
  private JMethod buildUpdate(JDefinedClass definedClass,
    ...
    ifCondition._then()._return(
      JExpr._new(codeModel.ref(ResponseEntity.class).narrowEmpty()).arg(codeModel.ref(HttpStatus.class).staticRef("NOT_FOUND")));
    ifCondition._else()._return(JExpr._new(codeModel.ref(ResponseEntity.class).narrowEmpty())
      .arg(JExpr.ref(service).invoke("update").arg(id).arg(updateForm)).arg(codeModel.ref(HttpStatus.class).staticRef("OK")));
  ...
  private JMethod buildDelete(JDefinedClass definedClass, Settings settings,
    ...
    conditional._then()._return(
      JExpr._new(codeModel.ref(ResponseEntity.class).narrowEmpty()).arg(codeModel.ref(HttpStatus.class).staticRef("OK")));
